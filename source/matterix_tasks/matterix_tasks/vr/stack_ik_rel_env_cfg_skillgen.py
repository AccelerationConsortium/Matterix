...
# Matterix Import
from matterix.devices.openxr.retargeters.franka import GripperVRRetargeterCfg, Se3RelVRRetargeterCfg
            ...
            devices={
                ...
                "motion_controllers": OpenXRDeviceCfg(
                    retargeters=[
                        ...
                        GripperVRRetargeterCfg(
                            bound_hand=DeviceBase.TrackingTarget.CONTROLLER_RIGHT, sim_device=self.sim.device
                        ),
                    ],
                    sim_device=self.sim.device,
                    xr_cfg=self.xr,
