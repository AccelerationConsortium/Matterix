...
from .matterix_marl_env_cfg import MatterixMarlEnvCfg


class MatterixMarlEnv(DirectMARLEnv):
    cfg: MatterixMarlEnvCfg

    def __init__(self, cfg: MatterixMarlEnvCfg, render_mode: str | None = None, **kwargs):
