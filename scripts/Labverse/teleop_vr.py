...
parser.add_argument(
    ...
    help=(
        ...
        " Built-ins: keyboard, spacemouse, gamepad, handtracking, motion_controllers. Not all tasks support all built-ins."
    ),
)
...
# The "XR" argument determines whether IsaacSim starts up with XR integration.
if "handtracking" or "motion_controllers" in args_cli.teleop_device.lower():
...
def main() -> None:
    ...
    if not isinstance(env_cfg, ManagerBasedRLEnvCfg):
        raise ValueError(
            "Teleoperation is only supported for ManagerBasedRLEnv environments. MatterixEnv support not yet implemented!"
